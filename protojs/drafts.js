...
//For ease of character creation:
  // pronouns: [
  //   'they',
  //   'their',
  //   'were',
...
const snowWhite = new GenericHero({
  createdAt: new Date(),
  hp: 20,
  name: 'Snow White',
  weapons: [
...
const evilQueen = new PlayerVillain({
  createdAt: new Date(),
  hp: 20,
  name: 'The Evil Queen',
  weapons: [
...
//CodePen can't display all returns necessary to actually kill one of the characters, so please open
